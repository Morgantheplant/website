define(function(require, exports, module) {
  ...
  function _createPlayButtons(position) {
    ...
    this.playButton.on('click', function(){
      if(this.stopped){
        ...
        this.reloadButton.setProperties({color:'rgb(128, 128, 128)', cursor:'default'})
        this.stopped = false;
        ...
        this.nextButton.setProperties({color:'rgb(0, 188, 0)', cursor:'pointer'})
         this.reloadButton.setProperties({color:'rgb(0, 188, 0)', cursor:'pointer'})
        this.stopped = true;
      }
    }.bind(this))
  ...
  function _createReloadButton(position){
    ...
    this.add(reloadButtonMod).add(this.reloadButton)
  }
