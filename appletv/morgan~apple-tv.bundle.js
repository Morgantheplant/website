...
"use strict";
FamousFramework.includes("morgan:apple-tv", "HEAD", ["morgan/apple-tv/jquery-1.11.3.min.js","morgan/apple-tv/galleryData.js","morgan/apple-tv/apple-tv.css"], function() {
    (function(){
        'use strict';
    ...
    (function(){
        ...
        'use strict';
        FamousFramework.component('morgan:apple-tv', 'HEAD', {
            'dependencies': {
                'famous:events': 'HEAD',
            ...
            tree: '<famous:core:node id="rotator-node">\n    <famous:core:node class="gallery-item">\n    </famous:core:node>\n</famous:core:node>\n'
        }).config({
            includes: [
    ...
    FamousFramework.markComponentAsReady("morgan:apple-tv", "HEAD");
});